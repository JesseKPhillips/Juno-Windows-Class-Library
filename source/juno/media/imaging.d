...
final class ImageFormat {
  ...
  /**
   */
  static @property ImageFormat memoryBmp() {
  ...
  /**
   */
  static @property ImageFormat bmp() { 
    if (bmp_ is null)
  ...
  /**
   */
  static @property ImageFormat emf() {
    if (emf_ is null)
  ...
  /**
   */
  static @property ImageFormat wmf() { 
    if (wmf_ is null)
  ...
  /**
   */
  static @property ImageFormat jpeg() {
    if (jpeg_ is null)
  ...
  /**
   */
  static @property ImageFormat png() {
    if (png_ is null)
  ...
  /**
   */
  static @property ImageFormat gif() { 
    if (gif_ is null)
  ...
  /**
   */
  static @property ImageFormat tiff() { 
    if (tiff_ is null)
  ...
  /**
   */
  static @property ImageFormat exif() { 
    if (exif_ is null)
  ...
  /**
   */
  static @property ImageFormat icon() { 
    if (icon_ !is null)
...
final class Encoder {
  ...
  /**
   */
  static @property Encoder compression() {
  ...
  /**
   */
  static @property Encoder colorDepth() {
  ...
  /**
   */
  static @property Encoder scanMethod() {
  ...
  /**
   */
  static @property Encoder _version() {
    if (version_ is null)
  ...
  /**
   */
  static @property Encoder renderMethod() {
  ...
  /**
   */
  static @property Encoder quality() {
    if (quality_ is null)
  ...
  /**
   */
  static @property Encoder transformation() {
  ...
  /**
   */
  static @property Encoder luminanceTable() {
  ...
  /**
   */
  static @property Encoder chrominanceTable() {
  ...
  /**
   */
  static @property Encoder saveFlag() {
...
final class EncoderParameter {
  ...
  /**
   */
  @property void encoder(Encoder value) {
    guid_ = value.guid;
  }
...
final class FrameDimension {
  ...
  /**
   */
  static @property FrameDimension time() {
    if (time_ is null)
  ...
  /**
   */
  static @property FrameDimension resolution() {
  ...
  /**
   */
  static @property FrameDimension page() {
    if (page_ is null)
